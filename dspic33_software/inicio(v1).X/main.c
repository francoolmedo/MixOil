...
unsigned int RESP1 = 0; // Adim  | 31 | 1000XFactor Mult Escala de T Int Reactor (0,500)  
unsigned int RESP2 = 0; // Adim  | 32 | 1000XFactor Mult Escala de T Cam Fuego (0,800)
unsigned int RESP3 = 0; // Adim  | 33 | 1000XFactor Mult Escala de Temp MixOil (0,059)
unsigned int RESP4 = 0; // Adim  | 34 | 1000XFactor Mult Escala Pres Int Reactor (0,050)
unsigned int RESP5 = 0; // Adim  | 35 | 10XFactor Mult Escala Vol Int Deposito (12,10)
        ...
        case 5:
            ...
            if (Punto == 5) {
                ...
                if ((SOFTK_N == 0) && (SOFTK_A == 2) && (apagar_M == 0) && (BANDERA_ALARMOL == 0) && (Lmarch == 0)) { //Lmarch == 1
                 ...
                 if ((SOFTK_N == 0) && (SOFTK_A == 1) && (BANDERA_ALARMOL == 0) && (BANDERA_molino == 1) && (Lmarch == 0)) { //Lmarch == 1
                    SOFTK_A = 0;
